    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a onclick="location.reload()">归还信息</a>
                </li>
                <li>
            </ol>
        </section>
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center">实际还书日期</th>
                            ...
                            <tr  v-if="showData" v-cloak v-for="(borrowBook,index) in borrowBooks" style="text-align: center;" :key="index">
                                ...
                                <td>{{borrowBook.rentalMoneyStr}}</td>
                            </tr>
                            ...
                            <div class="row data-type">
                                <div>
                                    ...
                                    <div class="col-md-3 data">
                                        <input type="text" readonly required class="form-control" placeholder="用户" name="rName">
                                    </div>
                                    <div class="col-md-2 title">图书名</div>
                                    <div class="col-md-5 data">
                                        <input type="text" readonly required class="form-control" placeholder="图书名" name="bName">
                                    </div>
                                </div>
                                <div>
                                    <div class="col-md-2 title">借书时间</div>
                                    <div class="col-md-3 data">
                                        <input type="text" readonly required class="form-control" placeholder="借书时间" name="dueTime">
                                    </div>
                                    <div class="col-md-2 title">应还书书时间</div>
                                    <div class="col-md-5 data">
                                        <input type="text" readonly required class="form-control" placeholder="应还书书时间" name="dueTime">
                                    </div>
                                </div>
                                <div>
                                    <div class="col-md-2 title">实际还书时间</div>
                                    <div class="col-md-3 data">
                                        <input type="text" readonly required class="form-control" placeholder="还书时间" name="dueTime">
                                    </div>
                                    <div class="col-md-2 title">借书天数</div>
                                    <div class="col-md-5 data">
                                        <input type="text" readonly required class="form-control" placeholder="借书天数" name="borrowBookDay">
                                    </div>
                                </div>
                                <div>
                                    <div class="col-md-2 title">租金单价</div>
                                    <div class="col-md-3 data">
                                        <input type="text" readonly required class="form-control" placeholder="租金单价" name="rentalUnit">
                                    </div>
                                    <div class="col-md-2 title">是否逾期</div>
                                    <div class="col-md-5 data">
                                        <input type="text" readonly required class="form-control" placeholder="是否逾期" name="isOverDue">
                                    </div>
                                </div>
                                <div>
                                    <div class="col-md-2 title">逾期扣除单价</div>
                                    <div class="col-md-3 data">
                                        <div readonly required class="form-control" placeholder="是否逾期" name="overDueRentalUnit"></div>
                                    </div>
                                    <div class="col-md-2 title">总计扣除金额</div>
                                    <div class="col-md-5 data">
                                        <input type="text" readonly required class="form-control" placeholder="扣除金额" name="rental">
                                    </div>
                                </div>
                                <div class="col-md-12 data text-center" style="margin-top: 20px;">
                                    <button type="button" class="btn bg-maroon" data-dismiss="modal">确定</button>
    ...
    let app = new Vue({
        ...
        methods: {
            ...
            searchBooks:async function(){
                ...
                if(searchObj.rgbId != undefined && searchObj.rgbId != ""){
                    searchUrl += "&rgbId="+searchObj.rgbId;
                }
            ...
            getBorrowBooks: async function (searchUrl = "") {
                let url = "<%=basePath%>reader/giveBack/"+this.currentPage+"/"+this.size;
                if(searchUrl!=""){
                    url += "?"+searchUrl;
                }
                this.showData = false;
            ...
            //还书 一个
            confirmGiveBack:function(rgbId){
                axios.post("<%=basePath%>/manager/giveBack/"+rgbId).then(response => {
                    console.log(response);
