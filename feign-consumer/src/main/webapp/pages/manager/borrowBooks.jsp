...
<div class="wrapper" id='app'>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <div class="col-md-4" >
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <div class="form-group form-inline">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modifyBook"
                                                    title="还书"><i class="fa fa-refresh"></i> 还书</button>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-1">
                            <button type="reset" style="display: inline-block;"  title="搜索" class="btn btn-default" onclick="location.href='<%=basePath%>/pages/manager/mailSet.jsp'">邮箱设置</button>
                        </div>
                            ...
                            <tr  v-if="showData" v-cloak v-for="(borrowBook,index) in borrowBooks" style="text-align: center;" :key="index">
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs"
                                            @click="returnBookRemind(index)" data-target="#modifyBook">提醒还书</button>
                                </td>
                            </tr>
    ...
    <%--发送邮箱提醒--%>
    <div>
        <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="false" aria-labelledby="mySmallModalLabel">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content" style="text-align: center" v-cloak>
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">发送邮箱提醒</h4>
                    </div>
                    <div class="modal-body">
                        <div style="letter-spacing: 2px">正在向"{{borrowBooks[sendMailIndex].rname}}"用户发送还书提醒{{dot}}</div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form id="addBookForm">
                                ...
                                <div class="row data-type">
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-3 data">
                                            <input type="text" :value="borrowBooksSuccess.realityTime" readonly required class="form-control" placeholder="还书时间" name="dueTime">
                                        </div>
    ...
    let app = new Vue({
        ...
        data: {
            ...
            borrowBooksSuccess: {"gbbId":1,"bbTime":"2020-07-06","dueTime":"2020-07-08",
                ...
                "bid":3,"rid":1,"bname":"软件学","overdue":false,
        ...
        methods: {
            //获取借阅图书，并重新加载页码
            getBooksAndReloadPageNum: async function(){
            ...
            getBorrowBooks: async function (searchUrl = "") {
                let url = "<%=basePath%>manager/borrowBook/"+this.currentPage+"/"+this.size;
                if(searchUrl!=""){
                    url += "?"+searchUrl;
                }
                this.showData = false;
            ...
            startDot:function(){
                ...
                this.dotInterval = setInterval(() => {
                    ...
                    Object.assign({},this.dot)
                },800);
            },
            stopDot:function(){
                $('.bs-example-modal-sm').modal('hide');
                clearTimeout(this.dotInterval);
            },
            //提醒还书
            returnBookRemind:function(index){
                let str = "";
                if(this.borrowBooks[index].remainingDays >= 0){ //未逾期
                    str = "未"
                }
                if(confirm("即将向用户发送\""+str+"逾期\"邮箱提醒，您确认吗？")){
                    this.sendMailIndex = index;
                    this.startDot();
                    axios.post("<%=basePath%>/manager/mail/remind/"+this.borrowBooks[index].bbId,).then(response => {
                        console.log(response)
                        this.stopDot();
                        alert("发送成功！");
                    }).catch(err => {
